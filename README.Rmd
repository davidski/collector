...
See the [package website](https://collector.severski.net) for 
...
6. Combine distributions into final parameters, applying weighting based on each SMEs level of calibrartion.
